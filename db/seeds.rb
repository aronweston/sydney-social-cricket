Player.destroy_all
player1 = Player.create :first_name => 'Admin', :last_name => 'Smith', :role => 'Top Order Batsman', :grade => 'A', :suburb => 2066, :bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.", :email => 'admin@test.com', :password => 'chicken', :admin => true

player2 = Player.create :first_name => 'Fred', :last_name => 'Jones', :role => 'Bowler', :grade => 'B', :suburb => 2044, :bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.", :email => 'fred@test.com', :password => 'chicken'

player3 = Player.create :first_name => 'Mike', :last_name => 'Woz', :role => 'All Rounder', :grade => 'C', :suburb => 2000, :bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.", :email => 'mike@test.com', :password => 'chicken'
...
team2 = Team.create :name => 'Waverly Termites', :grade => 'B', :suburb => 2055, :email => 'team2@team.com', :password => 'chicken', :bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede."

team3 = Team.create :name => 'St Leondards Giants', :grade => 'C', :suburb => 2053, :email => 'team3@team.com', :password => 'chicken', :bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede."

team4 = Team.create :name => 'City Lions', :grade => 'C', :suburb => 2053, :email => 'team3@team.com', :password => 'chicken',:bio => "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede."
